package com.hhbgk.calendarview;
...
public class ExtendedCalendarView extends RelativeLayout implements OnItemClickListener,
	 ...
	 */
	public void setMonthTextBackgroundDrawable(Drawable mipmap){
		if(Build.VERSION.SDK_INT > Build.VERSION_CODES.ICE_CREAM_SANDWICH_MR1){
			base.setBackground(mipmap);
		}
	 ...
	 * change the image of the previous month button
	 */
	public void setPreviousMonthButtonImageDrawable(Drawable mipmap){
		prev.setImageDrawable(mipmap);
	}
	 ...
	 * change the image of the next month button
	 */
	public void setNextMonthButtonImageDrawable(Drawable mipmap){
		next.setImageDrawable(mipmap);
	}
